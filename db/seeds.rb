...
photo1 = Photo.create(url: 'foo', user_id: user1.id)
photo2 = Photo.create(url: 'foo', user_id: user1.id)
photo3 = Photo.create(url: 'foo', user_id: user1.id)
photo4 = Photo.create(url: 'foo', user_id: user3.id)
photo5 = Photo.create(url: 'foo', user_id: user3.id)
photo6 = Photo.create(url: 'foo', user_id: user4.id)
photo7 = Photo.create(url: 'foo', user_id: user5.id)